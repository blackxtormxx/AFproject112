...
})({"6SNc6":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "01726d547d4dae758b3bc3d26d1f953d"; // @flow
...
},{}],"3ecqw":[function(require,module,exports) {
/*! @license DOMPurify 2.3.8 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.8/LICENSE */ (function(global, factory) {
    ...
    if (!apply) apply = function apply1(fun, thisValue, args) {
        return fun.apply(thisValue, args);
    };
    if (!freeze) freeze = function freeze1(x) {
        return x;
    };
    if (!seal) seal = function seal1(x) {
        return x;
    };
    if (!construct) construct = function construct1(Func, args) {
   ...
   * accordingly. */ function lookupGetter(object, prop) {
    ...
    var getGlobal = function getGlobal1() {
   ...
   * are not supported).
   */ var _createTrustedTypesPolicy = function _createTrustedTypesPolicy1(trustedTypes, document) {
        ...
        try {
            return trustedTypes.createPolicy(policyName, {
                createHTML: function createHTML(html1) {
                    return html1;
                }
            });
        } catch (_) {
    ...
    function createDOMPurify() {
        ...
        var DOMPurify = function DOMPurify1(root) {
     ...
     */ DOMPurify.removed = [];
        ...
        var DocumentFragment1 = window.DocumentFragment, HTMLTemplateElement1 = window.HTMLTemplateElement, Node1 = window.Node, Element1 = window.Element, NodeFilter1 = window.NodeFilter, _window$NamedNodeMap = window.NamedNodeMap, NamedNodeMap1 = _window$NamedNodeMap === void 0 ? window.NamedNodeMap || window.MozNamedAttrMap : _window$NamedNodeMap, HTMLFormElement1 = window.HTMLFormElement, DOMParser1 = window.DOMParser, trustedTypes = window.trustedTypes;
        var ElementPrototype = Element1.prototype;
        ...
        // is inherited.
        if (typeof HTMLTemplateElement1 === 'function') {
     ...
     */ /* allowed element names */ var ALLOWED_TAGS = null;
        ...
        }, [].concat(_toConsumableArray(html$1), _toConsumableArray(svg$1), _toConsumableArray(svgFilters), _toConsumableArray(mathMl$1), _toConsumableArray(text)));
        /* Allowed attribute names */ var ALLOWED_ATTR = null;
        var DEFAULT_ALLOWED_ATTR = addToSet({
        }, [].concat(_toConsumableArray(html), _toConsumableArray(svg), _toConsumableArray(mathMl), _toConsumableArray(xml)));
        /*
     ...
     * of importing it into a new Document and returning a sanitized copy */ var IN_PLACE = false;
        ...
        var isRegexOrFunction = function isRegexOrFunction1(testValue) {
     ...
     */ // eslint-disable-next-line complexity
        var _parseConfig = function _parseConfig1(cfg) {
            if (CONFIG && CONFIG === cfg) return;
            /* Shield configuration object from tampering */ if (!cfg || _typeof(cfg) !== 'object') cfg = {
            };
            /* Shield configuration object from prototype pollution */ cfg = clone(cfg);
            /* Set configuration parameters */ ALLOWED_TAGS = 'ALLOWED_TAGS' in cfg ? addToSet({
            }, cfg.ALLOWED_TAGS) : DEFAULT_ALLOWED_TAGS;
            ALLOWED_ATTR = 'ALLOWED_ATTR' in cfg ? addToSet({
            }, cfg.ALLOWED_ATTR) : DEFAULT_ALLOWED_ATTR;
            URI_SAFE_ATTRIBUTES = 'ADD_URI_SAFE_ATTR' in cfg ? addToSet(clone(DEFAULT_URI_SAFE_ATTRIBUTES), cfg.ADD_URI_SAFE_ATTR) : DEFAULT_URI_SAFE_ATTRIBUTES;
            DATA_URI_TAGS = 'ADD_DATA_URI_TAGS' in cfg ? addToSet(clone(DEFAULT_DATA_URI_TAGS), cfg.ADD_DATA_URI_TAGS) : DEFAULT_DATA_URI_TAGS;
            FORBID_CONTENTS = 'FORBID_CONTENTS' in cfg ? addToSet({
            }, cfg.FORBID_CONTENTS) : DEFAULT_FORBID_CONTENTS;
            FORBID_TAGS = 'FORBID_TAGS' in cfg ? addToSet({
            }, cfg.FORBID_TAGS) : {
            };
     ...
     * correctly. */ var ALL_SVG_TAGS = addToSet({
        }, svg$1);
        addToSet(ALL_SVG_TAGS, svgFilters);
        addToSet(ALL_SVG_TAGS, svgDisallowed);
        var ALL_MATHML_TAGS = addToSet({
        }, mathMl$1);
     ...
     */ var _checkValidNamespace = function _checkValidNamespace1(element) {
     ...
     */ var _forceRemove = function _forceRemove1(node) {
     ...
     * @param  {Node} node a DOM node
     */ var _removeAttribute = function _removeAttribute1(name, node) {
            try {
                arrayPush(DOMPurify.removed, {
     ...
     */ var _initDocument = function _initDocument1(dirty) {
       ...
       */ if (NAMESPACE === HTML_NAMESPACE) try {
                doc = new DOMParser1().parseFromString(dirtyPayload, PARSER_MEDIA_TYPE);
            } catch (_) {
            }
     ...
     */ var _createIterator = function _createIterator1(root) {
            return createNodeIterator.call(root.ownerDocument || root, root, NodeFilter1.SHOW_ELEMENT | NodeFilter1.SHOW_COMMENT | NodeFilter1.SHOW_TEXT, null, false);
        };
        /**
     * _isClobbered
     *
     ...
     */ var _isClobbered = function _isClobbered1(elm) {
            return elm instanceof HTMLFormElement1 && (typeof elm.nodeName !== 'string' || typeof elm.textContent !== 'string' || typeof elm.removeChild !== 'function' || !(elm.attributes instanceof NamedNodeMap1) || typeof elm.removeAttribute !== 'function' || typeof elm.setAttribute !== 'function' || typeof elm.namespaceURI !== 'string' || typeof elm.insertBefore !== 'function');
        };
        /**
     * _isNode
     *
     ...
     */ var _isNode = function _isNode1(object) {
            return _typeof(Node1) === 'object' ? object instanceof Node1 : object && _typeof(object) === 'object' && typeof object.nodeType === 'number' && typeof object.nodeName === 'string';
        };
        /**
     * _executeHook
     ...
     */ var _executeHook = function _executeHook1(entryPoint, currentNode, data) {
     ...
     */ var _sanitizeElements = function _sanitizeElements1(currentNode) {
            var content;
            ...
            /* Check whether element has a valid namespace */ if (currentNode instanceof Element1 && !_checkValidNamespace(currentNode)) {
                _forceRemove(currentNode);
                return true;
            }
     ...
     */ // eslint-disable-next-line complexity
        var _isValidAttribute = function _isValidAttribute1(lcTag, lcName, value) {
     ...
     */ var _basicCustomElementTest = function _basicCustomElementTest1(tagName) {
     ...
     */ var _sanitizeAttributes = function _sanitizeAttributes1(currentNode) {
            var attr;
            var value;
            var lcName;
            var l;
     ...
     */ var _sanitizeShadowDOM = function _sanitizeShadowDOM1(fragment) {
            var shadowNode;
            ...
            while(shadowNode = shadowIterator.nextNode()){
                ...
                /* Deep shadow DOM detected */ if (shadowNode.content instanceof DocumentFragment1) _sanitizeShadowDOM1(shadowNode.content);
     ...
     */ // eslint-disable-next-line complexity
        ...
        the user has requested a DOM object rather than a string */ IS_EMPTY_INPUT = !dirty;
            ...
            } else if (dirty instanceof Node1) {
           ...
           elements being stripped by the parser */ body = _initDocument('<!---->');
            ...
            /* Now start iterating over the created document */ while(currentNode = nodeIterator.nextNode()){
                ...
                /* Shadow DOM detected, sanitize it */ if (currentNode.content instanceof DocumentFragment1) _sanitizeShadowDOM(currentNode.content);
...
},{}]},["6SNc6"], null, "parcelRequire0de8")

//# sourceMappingURL=purify.6d1f953d.js.map
